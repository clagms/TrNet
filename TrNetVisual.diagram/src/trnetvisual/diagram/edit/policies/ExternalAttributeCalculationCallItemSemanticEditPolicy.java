 ...
 * @generated
 */
public class ExternalAttributeCalculationCallItemSemanticEditPolicy extends
		TrnetvisualBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExternalAttributeCalculationCallItemSemanticEditPolicy() {
		super(TrnetvisualElementTypes.ExternalAttributeCalculationCall_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TrnetvisualVisualIDRegistry.getVisualID(outgoingLink) == ExternalAttributeCalculationCallParameterEditPart.VISUAL_ID) {
			...
			if (TrnetvisualVisualIDRegistry.getVisualID(outgoingLink) == ExternalAttributeCalculationCallResultEditPart.VISUAL_ID) {
