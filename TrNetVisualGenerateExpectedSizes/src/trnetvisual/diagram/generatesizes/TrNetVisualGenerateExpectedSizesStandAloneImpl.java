 ...
 ******************************************************************************/
package trnetvisual.diagram.generatesizes;
 ...
 */
public class TrNetVisualGenerateExpectedSizesStandAloneImpl extends TrNetVisualGenerateExpectedSizesStandAlone {
	
	private String modelAbsolutePath;
	private String mmAbsolutePath;
	
	
	public TrNetVisualGenerateExpectedSizesStandAloneImpl(String modelAbsolutePath, String mmAbsolutePath){
	...
	public String getSource() throws Exception {
		return "GenerateExpectedSizes.eol";
	}
