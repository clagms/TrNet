 ...
 * @generated
 */
public class MandatoryNodeMandatoryNodeAttributesCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TrnetvisualPackage.eINSTANCE.getNodePattern_Attributes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getMandatoryNodeMandatoryNodeAttributesCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AttributePatternEditPart.VISUAL_ID == TrnetvisualVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getMandatoryNodeMandatoryNodeAttributesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
