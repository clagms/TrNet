 ...
 * <ul>
 *   <li>{@link uml.impl.RootPackageImpl#getPackagedElement <em>Packaged Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RootPackageImpl extends MinimalEObjectImpl.Container implements RootPackage {
	...
	protected EClass eStaticClass() {
		return UmlPackage.Literals.ROOT_PACKAGE;
	}
	...
	public EList<PackageableElement> getPackagedElement() {
		if (packagedElement == null) {
			packagedElement = new EObjectContainmentEList<PackageableElement>(PackageableElement.class, this, UmlPackage.ROOT_PACKAGE__PACKAGED_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UmlPackage.ROOT_PACKAGE__PACKAGED_ELEMENT:
