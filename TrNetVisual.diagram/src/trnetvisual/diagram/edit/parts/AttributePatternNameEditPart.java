 ...
 * @generated
 */
public class AttributePatternNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AttributePatternNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrnetvisualParserProvider
					.getParser(
							TrnetvisualElementTypes.AttributePattern_3004,
							getParserElement(),
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.AttributePatternNameEditPart.VISUAL_ID));
		}
		return parser;
	}
