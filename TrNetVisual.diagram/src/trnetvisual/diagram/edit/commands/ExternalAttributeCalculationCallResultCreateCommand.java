 ...
 * @generated
 */
public class ExternalAttributeCalculationCallResultCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ExternalAttributeCalculationCallResultCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof AttributePattern) {
			return false;
		}
		if (getSource() == null) {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateExternalAttributeCalculationCallResult_4017(
						getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected AttributePattern getTarget() {
		return (AttributePattern) target;
	}
}
