...
public class UnionTrNetPat27_TrNetPat25_TrNetPat18_TrNetPat2_0Instance{
	public ModelNode attribute0;
	public ModelNode cClass0;
	public ModelNode cClass0_1;
	...
	public int hashCode() {
		...
		result = prime * result + ((cClass0_1==null) ? 0 : cClass0_1.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnionTrNetPat27_TrNetPat25_TrNetPat18_TrNetPat2_0Instance other = (UnionTrNetPat27_TrNetPat25_TrNetPat18_TrNetPat2_0Instance) obj;
		if (attribute0==null) {
		...
		if (cClass0_1==null) {
			if (other.cClass0_1 != null) {
				return false;
			}
		} else if (! cClass0_1.equals(other.cClass0_1)) {
			return false;
		}
		if (table0==null) {
