...
import trnetvisual.diagram.edit.policies.AttributePatternItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AttributePatternEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AttributePatternEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AttributePatternItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AttributePatternFigure();
	}

	/**
	 * @generated
	 */
	public AttributePatternFigure getPrimaryShape() {
		return (AttributePatternFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AttributePatternNameEditPart) {
			((AttributePatternNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAttributePatternLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class AttributePatternFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAttributePatternLabelFigure;

		/**
		 * @generated
		 */
		public AttributePatternFigure() {
		...
		private void createContents() {
			...
			fFigureAttributePatternLabelFigure = new WrappingLabel();

			fFigureAttributePatternLabelFigure.setText("AttributePattern");

			this.add(fFigureAttributePatternLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAttributePatternLabelFigure() {
			return fFigureAttributePatternLabelFigure;
		}
