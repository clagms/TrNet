 ...
 */
public class EpsilonStandAloneImpl extends EpsilonStandAlone {
	
	private String modelAbsolutePath;
	private String mmAbsolutePath;
	
	
	public EpsilonStandAloneImpl(String modelAbsolutePath, String mmAbsolutePath){
		this.modelAbsolutePath = modelAbsolutePath;
		this.mmAbsolutePath = mmAbsolutePath;
	}
	
	@Override
	public EmlModule createModule() {
