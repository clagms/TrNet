 ...
 * @generated
 */
public class ExternalConditionCallItemSemanticEditPolicy extends
		TrnetvisualBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExternalConditionCallItemSemanticEditPolicy() {
		super(TrnetvisualElementTypes.ExternalConditionCall_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TrnetvisualVisualIDRegistry.getVisualID(outgoingLink) == ExternalConditionCallParameterEditPart.VISUAL_ID) {
