...
import trnetvisual.diagram.part.TrnetvisualDiagramEditorUtil;
...
public class OpenDiagramEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(TrnetvisualDiagramEditorUtil
													.getSaveOptions());
								}
							}
		...
		protected String getDiagramKind() {
			return TrNetModelEditPart.MODEL_ID;
		}
		...
		protected String getEditorID() {
			return TrnetvisualDiagramEditor.ID;
		}
	}
