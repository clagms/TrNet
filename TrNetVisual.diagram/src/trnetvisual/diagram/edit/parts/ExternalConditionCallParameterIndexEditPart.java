 ...
 * @generated
 */
public class ExternalConditionCallParameterIndexEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				TrnetvisualVisualIDRegistry
						.getType(trnetvisual.diagram.edit.parts.ExternalConditionCallParameterIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExternalConditionCallParameterIndexEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ExternalConditionCallParameterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExternalConditionCallParameterLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public ExternalConditionCallParameterLabelFigure() {
			this.setText("ExternalConditionCallParameter");
		}
