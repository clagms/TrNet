 ...
 * @generated
 */
public class ExternalCalculationCallItemSemanticEditPolicy extends
		TrnetvisualBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExternalCalculationCallItemSemanticEditPolicy() {
		super(TrnetvisualElementTypes.ExternalCalculationCall_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TrnetvisualVisualIDRegistry.getVisualID(outgoingLink) == ExternalCalculationCallParameterEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
