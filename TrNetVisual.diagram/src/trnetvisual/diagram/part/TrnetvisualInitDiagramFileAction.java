 ...
 * @generated
 */
public class TrnetvisualInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TrnetvisualNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				TrNetModelEditPart.MODEL_ID));
		TrnetvisualDiagramEditorUtil.runWizard(getShell(), wizard,
