...
import trnetvisual.diagram.edit.policies.ExternalItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExternalEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ExternalFigure();
	}

	/**
	 * @generated
	 */
	public ExternalFigure getPrimaryShape() {
		return (ExternalFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExternalExternalConditionsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getExternalConditionsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ExternalExternalConditionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ExternalExternalActionsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getExternalActionsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ExternalExternalActionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExternalExternalConditionsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getExternalConditionsCompartmentFigure();
			pane.remove(((ExternalExternalConditionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof ExternalExternalActionsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getExternalActionsCompartmentFigure();
			pane.remove(((ExternalExternalActionsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ExternalExternalConditionsCompartmentEditPart) {
			return getPrimaryShape().getExternalConditionsCompartmentFigure();
		}
		if (editPart instanceof ExternalExternalActionsCompartmentEditPart) {
			return getPrimaryShape().getExternalActionsCompartmentFigure();
		}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof trnetvisual.diagram.edit.parts.ExternalEditPart) {
			types.add(TrnetvisualElementTypes.Next_4009);
		}
		if (targetEditPart instanceof CombinatorEditPart) {
			types.add(TrnetvisualElementTypes.Eventually_4010);
	 ...
	 * @generated
	 */
	public class ExternalFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private RectangleFigure fExternalConditionsCompartmentFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fExternalActionsCompartmentFigure;
		...
		private void createContents() {
			...
			fExternalConditionsCompartmentFigure = new RectangleFigure();

			fExternalConditionsCompartmentFigure.setOutline(false);

			this.add(fExternalConditionsCompartmentFigure);

			fExternalActionsCompartmentFigure = new RectangleFigure();

			fExternalActionsCompartmentFigure.setOutline(false);

			this.add(fExternalActionsCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getExternalConditionsCompartmentFigure() {
			return fExternalConditionsCompartmentFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getExternalActionsCompartmentFigure() {
			return fExternalActionsCompartmentFigure;
		}
