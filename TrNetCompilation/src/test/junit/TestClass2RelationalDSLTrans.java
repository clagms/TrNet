...
import class2relacionaldsltrans.Class2RelacionalDSLTransTransformation;
import class2relacionaldsltransoriginal.Class2RelacionalDSLTransOriginalTransformation;
import classes.CModel;
import classes_visitor.ClassesInputVisitor;

public class TestClass2RelationalDSLTrans {
	...
	private Database runGeneratedTransformation() {
		...
		Class2RelacionalDSLTransTransformation transformation = new Class2RelacionalDSLTransTransformation();
		
		transformation.registerInputModelPublisher(inputv);

		transformation.registerOutputLayer2outputModelListener(outputv);
		
		CModel in = inputv.load("testing/TestClass2RelationalDSLTrans/ClassModel.xmi");
		...
		outputv.store(out, "testing/TestClass2RelationalDSLTrans/DatabaseOutGenerated.xmi");
	...
	private Database runOriginalTransformation() {
		...
		Class2RelacionalDSLTransOriginalTransformation transformation = new Class2RelacionalDSLTransOriginalTransformation();
		...
		outputv.store(out, "testing/TestClass2RelationalDSLTrans/DatabaseOutOriginal.xmi");
