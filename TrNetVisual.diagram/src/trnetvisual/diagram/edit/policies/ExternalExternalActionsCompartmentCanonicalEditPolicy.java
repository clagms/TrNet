 ...
 * @generated
 */
public class ExternalExternalActionsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getExternalExternalActionsCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getExternalExternalActionsCompartment_7004SemanticChildren((View) getHost()
						.getModel());
