...
public class TrNetPat165Instance{
	public ModelNode transition0;
	public ModelNode objectFlowState0;
	public ModelNode objectFlowState1;
	...
	public int hashCode() {
		...
		result = prime * result + ((objectFlowState1==null) ? 0 : objectFlowState1.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrNetPat165Instance other = (TrNetPat165Instance) obj;
		if (transition0==null) {
		...
		if (objectFlowState1==null) {
			if (other.objectFlowState1 != null) {
				return false;
			}
		} else if (! objectFlowState1.equals(other.objectFlowState1)) {
			return false;
		}
		return true;
	}
