 ...
 * @generated
 */
public class ExternalCalculationCallParameterIndexEditPart extends
	...
	static {
		registerSnapBackPosition(
				TrnetvisualVisualIDRegistry
						.getType(trnetvisual.diagram.edit.parts.ExternalCalculationCallParameterIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExternalCalculationCallParameterIndexEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ExternalCalculationCallParameterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExternalCalculationCallParameterLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public ExternalCalculationCallParameterLabelFigure() {
			this.setText("ExternalCalculationCallParameter");
		}
