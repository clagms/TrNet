 ...
 * <ul>
 *   <li>{@link minuml1.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends StateVertexImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return Minuml1Package.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Minuml1Package.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Minuml1Package.PSEUDOSTATE__KIND:
				return getKind();
		}
