...
public abstract class EpsilonStandAlone {
	...
	protected EmlModule module;
	
	protected Object result;
	
	public abstract EmlModule createModule();
	...
	public void execute() throws Exception {
		...
		Lexer l = module.createLexer(new FileInputStream(getFile(getSource())));
	...
	protected File getFile(String fileName) throws URISyntaxException {
		...
		URL uri = null;
		try {
			binUri = EpsilonStandAlone.class.
