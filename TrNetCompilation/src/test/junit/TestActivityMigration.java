...
import activitymigration.ActivityMigrationTransformation;
import activitymigrationoriginal.ActivityMigrationOriginalTransformation;

public class TestActivityMigration {
	...
	private uml.RootPackage runGeneratedTransformation() {
		...
		RootActivityGraph s = inputv.load("testing/TestActivityMigration/random_model_100.xmi");
		...
		outputv.store(d, "testing/TestActivityMigration/Generated.xmi");
	...
	private uml.RootPackage runOriginalTransformation() {
		...
		ActivityMigrationOriginalTransformation transformation = new ActivityMigrationOriginalTransformation();
		...
		outputv.store(d, "testing/TestActivityMigration/Original.xmi");
