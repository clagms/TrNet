...
import trnetvisual.diagram.edit.policies.TrnetvisualTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ExternalAttributeCalculationCallParameterIndexEditPart extends
	...
	static {
		registerSnapBackPosition(
				TrnetvisualVisualIDRegistry
						.getType(trnetvisual.diagram.edit.parts.ExternalAttributeCalculationCallParameterIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExternalAttributeCalculationCallParameterIndexEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TrnetvisualTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new TrNetModelEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrnetvisualParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					TrnetvisualEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new ExternalAttributeCalculationCallParameterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExternalAttributeCalculationCallParameterLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public ExternalAttributeCalculationCallParameterLabelFigure() {
			this.setText("ExternalAttributeCalculationCallParameter");
		}
