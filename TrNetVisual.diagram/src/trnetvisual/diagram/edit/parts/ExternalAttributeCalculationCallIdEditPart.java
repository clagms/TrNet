 ...
 * @generated
 */
public class ExternalAttributeCalculationCallIdEditPart extends
	 ...
	 * @generated
	 */
	public ExternalAttributeCalculationCallIdEditPart(View view) {
		super(view);
	}
			...
			parser = TrnetvisualParserProvider
					.getParser(
							...
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.ExternalAttributeCalculationCallIdEditPart.VISUAL_ID));
		}
		return parser;
	}
