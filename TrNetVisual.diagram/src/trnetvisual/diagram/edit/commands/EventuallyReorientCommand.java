 ...
 * @generated
 */
public class EventuallyReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EventuallyReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Eventually) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEventually_4010(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TrNetModel container = (TrNetModel) getLink().eContainer();
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEventually_4010(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Eventually getLink() {
		return (Eventually) getElementToEdit();
	}
