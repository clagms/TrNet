...
public class ClassesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ClassesPackage.CCLASS: {
				CClass cClass = (CClass)theEObject;
				T result = caseCClass(cClass);
				if (result == null) result = caseClassifier(cClass);
				if (result == null) result = caseNamedElement(cClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
