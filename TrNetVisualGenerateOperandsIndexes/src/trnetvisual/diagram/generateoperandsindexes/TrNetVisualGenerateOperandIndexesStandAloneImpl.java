 ...
 ******************************************************************************/
package trnetvisual.diagram.generateoperandsindexes;
 ...
 */
public class TrNetVisualGenerateOperandIndexesStandAloneImpl extends TrNetVisualGenerateOperandIndexesStandAlone {
	
	private String modelAbsolutePath;
	private String mmAbsolutePath;
	
	
	public TrNetVisualGenerateOperandIndexesStandAloneImpl(String modelAbsolutePath, String mmAbsolutePath){
	...
	public String getSource() throws Exception {
		return "GenerateOperandIndexes.eol";
	}
