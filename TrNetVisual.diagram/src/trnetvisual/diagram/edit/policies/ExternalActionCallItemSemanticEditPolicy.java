 ...
 * @generated
 */
public class ExternalActionCallItemSemanticEditPolicy extends
		TrnetvisualBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExternalActionCallItemSemanticEditPolicy() {
		super(TrnetvisualElementTypes.ExternalActionCall_3002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (TrnetvisualVisualIDRegistry.getVisualID(outgoingLink) == ExternalActionCallParameterEditPart.VISUAL_ID) {
