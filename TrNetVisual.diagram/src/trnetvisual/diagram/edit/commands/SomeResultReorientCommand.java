 ...
 * @generated
 */
public class SomeResultReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SomeResultReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SomeResult) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeResult_4004(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TrNetModel container = (TrNetModel) getLink().eContainer();
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeResult_4004(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SomeResult getLink() {
		return (SomeResult) getElementToEdit();
	}
