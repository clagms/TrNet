 ...
 * @generated
 */
public class NextReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NextReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Next) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistNext_4009(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistNext_4009(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Next getLink() {
		return (Next) getElementToEdit();
	}
