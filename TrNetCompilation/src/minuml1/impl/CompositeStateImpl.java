 ...
 * <ul>
 *   <li>{@link minuml1.impl.CompositeStateImpl#getSubvertex <em>Subvertex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeStateImpl extends StateImpl implements CompositeState {
	...
	protected EClass eStaticClass() {
		return Minuml1Package.Literals.COMPOSITE_STATE;
	}
	...
	public EList<StateVertex> getSubvertex() {
		if (subvertex == null) {
			subvertex = new EObjectContainmentEList<StateVertex>(StateVertex.class, this, Minuml1Package.COMPOSITE_STATE__SUBVERTEX);
		}
		return subvertex;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Minuml1Package.COMPOSITE_STATE__SUBVERTEX:
