...
public class ActivityPartitionImpl extends NamedElementImpl implements ActivityPartition {
	...
	public EList<ActivityNode> getNode() {
		if (node == null) {
			node = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UmlPackage.ACTIVITY_PARTITION__NODE);
		}
		return node;
	}
	...
	public EList<ActivityEdge> getEdge() {
		if (edge == null) {
			edge = new EObjectResolvingEList<ActivityEdge>(ActivityEdge.class, this, UmlPackage.ACTIVITY_PARTITION__EDGE);
		}
		return edge;
	}
