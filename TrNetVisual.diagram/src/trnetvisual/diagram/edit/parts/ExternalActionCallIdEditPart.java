 ...
 * @generated
 */
public class ExternalActionCallIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExternalActionCallIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrnetvisualParserProvider
					.getParser(
							TrnetvisualElementTypes.ExternalActionCall_3002,
							getParserElement(),
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.ExternalActionCallIdEditPart.VISUAL_ID));
		}
		return parser;
	}
