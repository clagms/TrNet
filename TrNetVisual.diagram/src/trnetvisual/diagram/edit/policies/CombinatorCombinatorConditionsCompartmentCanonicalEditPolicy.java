 ...
 * @generated
 */
public class CombinatorCombinatorConditionsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TrnetvisualPackage.eINSTANCE.getOperator_Conditions();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getCombinatorCombinatorConditionsCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ExternalConditionCallEditPart.VISUAL_ID == TrnetvisualVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getCombinatorCombinatorConditionsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
