 ...
 * @generated
 */
public class ExternalCalculationCallIdEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExternalCalculationCallIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new TrNetModelEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return TrnetvisualElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrnetvisualParserProvider
					.getParser(
							TrnetvisualElementTypes.ExternalCalculationCall_2002,
							getParserElement(),
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.ExternalCalculationCallIdEditPart.VISUAL_ID));
		}
		return parser;
	}
