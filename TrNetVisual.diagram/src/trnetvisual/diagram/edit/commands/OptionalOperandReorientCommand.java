 ...
 * @generated
 */
public class OptionalOperandReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OptionalOperandReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OptionalOperand) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOptionalOperand_4008(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TrNetModel container = (TrNetModel) getLink().eContainer();
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOptionalOperand_4008(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OptionalOperand getLink() {
		return (OptionalOperand) getElementToEdit();
	}
