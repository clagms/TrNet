 ...
 * @generated
 */
public class CombinatorCombinatorActionsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TrnetvisualPackage.eINSTANCE.getOperator_Actions();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getCombinatorCombinatorActionsCompartment_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ExternalActionCallEditPart.VISUAL_ID == TrnetvisualVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getCombinatorCombinatorActionsCompartment_7002SemanticChildren((View) getHost()
						.getModel());
