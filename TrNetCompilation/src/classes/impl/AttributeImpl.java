 ...
 * <ul>
 *   <li>{@link classes.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link classes.impl.AttributeImpl#isIsMany <em>Is Many</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends NamedElementImpl implements Attribute {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.ATTRIBUTE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setIsMany(boolean newIsMany) {
		...
		isMany = newIsMany;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ATTRIBUTE__IS_MANY, oldIsMany, isMany));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.ATTRIBUTE__TYPE:
				...
				return basicGetType();
			case ClassesPackage.ATTRIBUTE__IS_MANY:
				return isIsMany();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (derivedFeatureID) {
				case ClassesPackage.ATTRIBUTE__TYPE: return ClassesPackage.TYPED_ELEMENT__TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseFeatureID) {
				case ClassesPackage.TYPED_ELEMENT__TYPE: return ClassesPackage.ATTRIBUTE__TYPE;
				default: return -1;
			}
		}
