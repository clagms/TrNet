 ...
 * @generated
 */
public class SomeOperandReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SomeOperandReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SomeOperand) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeOperand_4006(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TrNetModel container = (TrNetModel) getLink().eContainer();
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSomeOperand_4006(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SomeOperand getLink() {
		return (SomeOperand) getElementToEdit();
	}
