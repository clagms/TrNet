...
public class GenerateOperandIndexesTool extends AbstractTool{
	...
	public void activate() {
		...
		try {
			...
			new TrNetVisualGenerateOperandIndexesStandAloneImpl(modelSchemeSpecificPart, mmSchemeSpecificPart).execute();
