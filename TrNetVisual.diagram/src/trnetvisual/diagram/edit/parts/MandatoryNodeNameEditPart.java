 ...
 * @generated
 */
public class MandatoryNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MandatoryNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = TrnetvisualParserProvider
					.getParser(
							...
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.MandatoryNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
