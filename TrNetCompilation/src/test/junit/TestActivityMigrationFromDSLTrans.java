...
public class TestActivityMigrationFromDSLTrans {
	...
	private uml.RootPackage runGeneratedTransformation() {
		...
		ActivityMigrationGeneratedFromDSLTransTransformation transformation = new ActivityMigrationGeneratedFromDSLTransTransformation();

		transformation.registerInputModelPublisher(inputv);

		transformation.registerOutputLayer1migrated_modelListener(outputv);

		RootActivityGraph s = inputv.load("testing/TestActivityMigrationFromDSLTrans/random_model_100.xmi");
		...
		outputv.store(d, "testing/TestActivityMigrationFromDSLTrans/Generated.xmi");
	...
	private uml.RootPackage runOriginalTransformation() {
		...
		outputv.store(d, "testing/TestActivityMigrationFromDSLTrans/Original.xmi");
