...
public class Class2RelationalExplicitMedTransformation
			...
			,TrNetPat13InstancePublisher
{
	...
	HashSet<TrNetPat27Instance> trNetPat27Set; 
		HashMap<ModelNode, LinkedList<TrNetPat27Instance>> attribute0InTrNetPat27Hash;
	...
	ArrayList<UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance> unionTrNetPat25_TrNetPat24_TrNetPat18_0Array;
	HashSet<UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance> unionTrNetPat25_TrNetPat24_TrNetPat18_0Set; 
	ArrayList<UnionTrNetPat24_TrNetPat18_0Instance> unionTrNetPat24_TrNetPat18_0Array;
	HashSet<UnionTrNetPat24_TrNetPat18_0Instance> unionTrNetPat24_TrNetPat18_0Set; 
		HashMap<ModelNode, LinkedList<UnionTrNetPat24_TrNetPat18_0Instance>> cClass0InUnionTrNetPat24_TrNetPat18_0Hash;
	ArrayList<UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance> unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Array;
	HashSet<UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance> unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Set; 
	ArrayList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance> unionTrNetPat18_TrNetPat24_TrNetPat2_0Array;
	HashSet<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance> unionTrNetPat18_TrNetPat24_TrNetPat2_0Set; 
		HashMap<ModelNode, LinkedList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance>> cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash;
	ArrayList<UnionTrNetPat18_TrNetPat24_1Instance> unionTrNetPat18_TrNetPat24_1Array;
	HashSet<UnionTrNetPat18_TrNetPat24_1Instance> unionTrNetPat18_TrNetPat24_1Set; 
	
	public Class2RelationalExplicitMedTransformation(){
	...
	trNetPat27Set = new HashSet<TrNetPat27Instance>(9998); 
		attribute0InTrNetPat27Hash = new HashMap<ModelNode, LinkedList<TrNetPat27Instance>>(9998);
	...
	unionTrNetPat25_TrNetPat24_TrNetPat18_0Array = new ArrayList<UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance>(20000); 
	unionTrNetPat25_TrNetPat24_TrNetPat18_0Set = new HashSet<UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance>(20000); 
	unionTrNetPat24_TrNetPat18_0Array = new ArrayList<UnionTrNetPat24_TrNetPat18_0Instance>(20000); 
	unionTrNetPat24_TrNetPat18_0Set = new HashSet<UnionTrNetPat24_TrNetPat18_0Instance>(20000); 
		cClass0InUnionTrNetPat24_TrNetPat18_0Hash = new HashMap<ModelNode, LinkedList<UnionTrNetPat24_TrNetPat18_0Instance>>(20000);
	unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Array = new ArrayList<UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance>(20000); 
	unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Set = new HashSet<UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance>(20000); 
	unionTrNetPat18_TrNetPat24_TrNetPat2_0Array = new ArrayList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance>(20000); 
	unionTrNetPat18_TrNetPat24_TrNetPat2_0Set = new HashSet<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance>(20000); 
		cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash = new HashMap<ModelNode, LinkedList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance>>(20000);
	unionTrNetPat18_TrNetPat24_1Array = new ArrayList<UnionTrNetPat18_TrNetPat24_1Instance>(20000); 
	unionTrNetPat18_TrNetPat24_1Set = new HashSet<UnionTrNetPat18_TrNetPat24_1Instance>(20000); 
	...
	executeOperatorOpunionTrNetPat18_TrNetPat24_1();
	...
	executeOperatorOpunionTrNetPat24_TrNetPat18_0();
	executeOperatorOpunionTrNetPat25_TrNetPat24_TrNetPat18_0();
	...
	executeOperatorOpunionTrNetPat18_TrNetPat24_TrNetPat2_0();
	executeOperatorOpunionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0();
	...
	public HashMap<String, generic.PatternStats> retrieveExpectedAndRealSizesPatterns() {
		HashMap<String, generic.PatternStats> result = new HashMap<String, generic.PatternStats>();
			...
			}
			{
				...
				patternStats.expectedSize = 20000.0;
				patternStats.realSize = unionTrNetPat25_TrNetPat24_TrNetPat18_0Set.size();
				
				
				result.put("unionTrNetPat25_TrNetPat24_TrNetPat18_0", patternStats);
			}
			{
				generic.PatternStats patternStats = new generic.PatternStats();
				
				patternStats.expectedSize = 20000.0;
				patternStats.realSize = unionTrNetPat24_TrNetPat18_0Set.size();
				
				
				result.put("unionTrNetPat24_TrNetPat18_0", patternStats);
			}
			{
				generic.PatternStats patternStats = new generic.PatternStats();
				
				patternStats.expectedSize = 20000.0;
				patternStats.realSize = unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Set.size();
				
				
				result.put("unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0", patternStats);
			}
			{
				generic.PatternStats patternStats = new generic.PatternStats();
				
				patternStats.expectedSize = 20000.0;
				patternStats.realSize = unionTrNetPat18_TrNetPat24_TrNetPat2_0Set.size();
				
				
				result.put("unionTrNetPat18_TrNetPat24_TrNetPat2_0", patternStats);
			}
			{
				generic.PatternStats patternStats = new generic.PatternStats();
				
				patternStats.expectedSize = 20000.0;
				patternStats.realSize = unionTrNetPat18_TrNetPat24_1Set.size();
				
				
				result.put("unionTrNetPat18_TrNetPat24_1", patternStats);
			}
	...
	public void generateOutputCSVStats(String directory_path) {
		...
		try{
		    ...
		    patternStatsFile.append('\n');
				...
				{
					generic.PatternStats patternStats = statsMap.get("unionTrNetPat25_TrNetPat24_TrNetPat18_0");
					
					patternStatsFile.append("unionTrNetPat25_TrNetPat24_TrNetPat18_0");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.expectedSize + "");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.realSize + "");
				...
				{
					generic.PatternStats patternStats = statsMap.get("unionTrNetPat24_TrNetPat18_0");
					
					patternStatsFile.append("unionTrNetPat24_TrNetPat18_0");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.expectedSize + "");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.realSize + "");
				...
				{
					generic.PatternStats patternStats = statsMap.get("unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0");
					
					patternStatsFile.append("unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.expectedSize + "");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.realSize + "");
				...
				{
					generic.PatternStats patternStats = statsMap.get("unionTrNetPat18_TrNetPat24_TrNetPat2_0");
					
					patternStatsFile.append("unionTrNetPat18_TrNetPat24_TrNetPat2_0");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.expectedSize + "");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.realSize + "");
				...
				{
					generic.PatternStats patternStats = statsMap.get("unionTrNetPat18_TrNetPat24_1");
					
					patternStatsFile.append("unionTrNetPat18_TrNetPat24_1");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.expectedSize + "");
				    patternStatsFile.append(',');
				    patternStatsFile.append(patternStats.realSize + "");
	...
	{
		if (!attribute0InTrNetPat27Hash.containsKey(element.attribute0)) {
			attribute0InTrNetPat27Hash.put(element.attribute0, new LinkedList<TrNetPat27Instance>());
		}
		attribute0InTrNetPat27Hash.get(element.attribute0).add(element);
	}
			/*
	executeOperatorTrNetOp39();
	executeOperatorTrNetOp19();
...
boolean executeOperatorTrNetOp39() {
	...
	int sourcePatternSize1 = unionTrNetPat25_TrNetPat24_TrNetPat18_0Array.size();
	
	for (int i = 0; i<sourcePatternSize1; i++){
		UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance sourcePatternInstance1 = unionTrNetPat25_TrNetPat24_TrNetPat18_0Array.get(i);
	...
	if (! generic.utils.Conditions.isInteger(sourcePatternInstance1.datatype0.attributes.get("name"))) {
		continue;
			...
			LinkedList<TrNetPat27Instance> sourcePatternInstances2 = attribute0InTrNetPat27Hash.get(sourcePatternInstance1.attribute0);
			
			if (sourcePatternInstances2 != null) {
				for (TrNetPat27Instance sourcePatternInstance2 : sourcePatternInstances2) {
...
boolean executeOperatorTrNetOp19() {
	...
	int sourcePatternSize1 = unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Array.size();
	
	for (int i = 0; i<sourcePatternSize1; i++){
		UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance sourcePatternInstance1 = unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Array.get(i);
	...
	- Cada cada attribute pattern do no,
		...
		- Nessa fncao, coloca os parametros respectivos.
	*/
	node.attributes.put("name", generic.utils.AttrCalculation.junctablecolid(sourcePatternInstance1.cClass0_0.attributes.get("name")));
	node.types.add("Column");
...
boolean executeOperatorOpunionTrNetPat25_TrNetPat24_TrNetPat18_0() {
	boolean operatorHasExecuted = false;
	...
	for (int i = 0; i<sourcePatternSize1; i++){
		TrNetPat25Instance sourcePatternInstance1 = trNetPat25Array.get(i);
			...
			LinkedList<UnionTrNetPat24_TrNetPat18_0Instance> sourcePatternInstances2 = cClass0InUnionTrNetPat24_TrNetPat18_0Hash.get(sourcePatternInstance1.cClass0);
			
			if (sourcePatternInstances2 != null) {
				for (UnionTrNetPat24_TrNetPat18_0Instance sourcePatternInstance2 : sourcePatternInstances2) {
					
					
					
	{
			totalCombinationsCounter++;
		UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance targetInstance = new UnionTrNetPat25_TrNetPat24_TrNetPat18_0Instance();
			{
			targetInstance.attribute0 = sourcePatternInstance1.attribute0;
			targetInstance.attribute0.types.add("Attribute");
			}
		...
		if (unionTrNetPat25_TrNetPat24_TrNetPat18_0Set.add(targetInstance)) {
				totalElementPlacementCounter++;
			unionTrNetPat25_TrNetPat24_TrNetPat18_0Array.add(targetInstance);
	//patternUnionTrNetPat25_TrNetPat24_TrNetPat18_0HasChanged = true; // Isto agora deixa de fazer sentido ja que o controlo passa a estar no metofdo run.
	operatorHasExecuted = true;
		}
	}
				}
...
boolean executeOperatorOpunionTrNetPat24_TrNetPat18_0() {
	boolean operatorHasExecuted = false;
	...
	{
			totalCombinationsCounter++;
		UnionTrNetPat24_TrNetPat18_0Instance targetInstance = new UnionTrNetPat24_TrNetPat18_0Instance();
			{
			targetInstance.type0 = sourcePatternInstance1.type0;
			targetInstance.type0.types.add("Type");
			}
		...
		if (unionTrNetPat24_TrNetPat18_0Set.add(targetInstance)) {
				totalElementPlacementCounter++;
			unionTrNetPat24_TrNetPat18_0Array.add(targetInstance);
	{
		if (!cClass0InUnionTrNetPat24_TrNetPat18_0Hash.containsKey(targetInstance.cClass0)) {
			cClass0InUnionTrNetPat24_TrNetPat18_0Hash.put(targetInstance.cClass0, new LinkedList<UnionTrNetPat24_TrNetPat18_0Instance>());
		}
		cClass0InUnionTrNetPat24_TrNetPat18_0Hash.get(targetInstance.cClass0).add(targetInstance);
	}
	//patternUnionTrNetPat24_TrNetPat18_0HasChanged = true; // Isto agora deixa de fazer sentido ja que o controlo passa a estar no metofdo run.
	operatorHasExecuted = true;
		}
	}
			}
...
boolean executeOperatorOpunionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0() {
	boolean operatorHasExecuted = false;
	...
	for (int i = 0; i<sourcePatternSize1; i++){
		TrNetPat25Instance sourcePatternInstance1 = trNetPat25Array.get(i);
			...
			LinkedList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance> sourcePatternInstances2 = cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash.get(sourcePatternInstance1.cClass0);
			
			if (sourcePatternInstances2 != null) {
				for (UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance sourcePatternInstance2 : sourcePatternInstances2) {
					
					
					
	{
			totalCombinationsCounter++;
		UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance targetInstance = new UnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Instance();
			{
			targetInstance.attribute0 = sourcePatternInstance1.attribute0;
			targetInstance.attribute0.types.add("Attribute");
			}
		...
		if (unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Set.add(targetInstance)) {
				totalElementPlacementCounter++;
			unionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0Array.add(targetInstance);
	//patternUnionTrNetPat25_TrNetPat18_TrNetPat24_TrNetPat2_0HasChanged = true; // Isto agora deixa de fazer sentido ja que o controlo passa a estar no metofdo run.
	operatorHasExecuted = true;
		}
	}
				}
...
boolean executeOperatorOpunionTrNetPat18_TrNetPat24_TrNetPat2_0() {
	boolean operatorHasExecuted = false;
	...
	for (int i = 0; i<sourcePatternSize1; i++){
		TrNetPat2Instance sourcePatternInstance1 = trNetPat2Array.get(i);
			...
			int sourcePatternSize2 = unionTrNetPat18_TrNetPat24_1Array.size();
			
			for (int j = 0; j<sourcePatternSize2; j++){
				UnionTrNetPat18_TrNetPat24_1Instance sourcePatternInstance2 = unionTrNetPat18_TrNetPat24_1Array.get(j);
				
				
				
	{
			totalCombinationsCounter++;
		UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance targetInstance = new UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance();
			{
			targetInstance.database0 = sourcePatternInstance1.database0;
			targetInstance.database0.types.add("Database");
			}
		...
		if (unionTrNetPat18_TrNetPat24_TrNetPat2_0Set.add(targetInstance)) {
				totalElementPlacementCounter++;
			unionTrNetPat18_TrNetPat24_TrNetPat2_0Array.add(targetInstance);
	{
		if (!cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash.containsKey(targetInstance.cClass0)) {
			cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash.put(targetInstance.cClass0, new LinkedList<UnionTrNetPat18_TrNetPat24_TrNetPat2_0Instance>());
		}
		cClass0InUnionTrNetPat18_TrNetPat24_TrNetPat2_0Hash.get(targetInstance.cClass0).add(targetInstance);
	}
	//patternUnionTrNetPat18_TrNetPat24_TrNetPat2_0HasChanged = true; // Isto agora deixa de fazer sentido ja que o controlo passa a estar no metofdo run.
	operatorHasExecuted = true;
		}
	}
			}
...
boolean executeOperatorOpunionTrNetPat18_TrNetPat24_1() {
	boolean operatorHasExecuted = false;
	...
	{
			totalCombinationsCounter++;
		UnionTrNetPat18_TrNetPat24_1Instance targetInstance = new UnionTrNetPat18_TrNetPat24_1Instance();
			{
			targetInstance.cClass0 = sourcePatternInstance1.cClass0;
			targetInstance.cClass0.types.add("CClass");
			}
		...
		if (unionTrNetPat18_TrNetPat24_1Set.add(targetInstance)) {
				totalElementPlacementCounter++;
			unionTrNetPat18_TrNetPat24_1Array.add(targetInstance);
	//patternUnionTrNetPat18_TrNetPat24_1HasChanged = true; // Isto agora deixa de fazer sentido ja que o controlo passa a estar no metofdo run.
	operatorHasExecuted = true;
		}
	}
			}
