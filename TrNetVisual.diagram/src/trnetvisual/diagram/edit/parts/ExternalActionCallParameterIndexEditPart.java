 ...
 * @generated
 */
public class ExternalActionCallParameterIndexEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				TrnetvisualVisualIDRegistry
						.getType(trnetvisual.diagram.edit.parts.ExternalActionCallParameterIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExternalActionCallParameterIndexEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ExternalActionCallParameterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExternalActionCallParameterLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExternalActionCallParameterLabelFigure() {
			this.setText("ExternalActionCallParameter");
		}
