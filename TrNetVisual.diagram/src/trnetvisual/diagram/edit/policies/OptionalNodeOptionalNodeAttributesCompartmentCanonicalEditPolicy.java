 ...
 * @generated
 */
public class OptionalNodeOptionalNodeAttributesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getOptionalNodeOptionalNodeAttributesCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getOptionalNodeOptionalNodeAttributesCompartment_7007SemanticChildren((View) getHost()
						.getModel());
