 ...
 * @generated
 */
public class TrnetvisualCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public TrnetvisualCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", TrNetModelEditPart.MODEL_ID); //$NON-NLS-1$
