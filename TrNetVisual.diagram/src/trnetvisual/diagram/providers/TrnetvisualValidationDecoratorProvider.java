...
import trnetvisual.diagram.part.TrnetvisualDiagramEditor;
 ...
 * @generated
 */
public class TrnetvisualValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = TrnetvisualDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof TrnetvisualDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& TrNetModelEditPart.MODEL_ID
						.equals(TrnetvisualVisualIDRegistry.getModelID(view));
	}
