 ...
 * @generated
 */
public class PatternPatternNodesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TrnetvisualPackage.eINSTANCE.getPattern_Nodes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getPatternPatternNodesCompartment_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == MandatoryNodeEditPart.VISUAL_ID
				|| visualID == OptionalNodeEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getPatternPatternNodesCompartment_7005SemanticChildren((View) getHost()
						.getModel());
