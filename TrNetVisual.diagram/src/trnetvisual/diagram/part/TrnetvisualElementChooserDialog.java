 ...
 * @generated
 */
public class TrnetvisualElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public TrnetvisualElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.TrnetvisualElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "trnetvisual".equals(fileExtension); //$NON-NLS-1$
	}
