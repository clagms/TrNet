...
public class GenerateExpectedSizesTool extends AbstractTool{

	@Override
	protected String getCommandName() {
		return "Generate Expected Indexes";
	}
	...
	public void activate() {
		...
		try {
			...
			new TrNetVisualGenerateExpectedSizesStandAloneImpl(modelSchemeSpecificPart, mmSchemeSpecificPart).execute();
