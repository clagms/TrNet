 ...
 * @generated
 */
public class EdgePatternNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TrnetvisualVisualIDRegistry
						.getType(trnetvisual.diagram.edit.parts.EdgePatternNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EdgePatternNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new EdgePatternLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EdgePatternLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EdgePatternLabelFigure() {
			this.setText("EdgePattern");
		}
