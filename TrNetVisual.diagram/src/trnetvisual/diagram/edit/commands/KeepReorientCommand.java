 ...
 * @generated
 */
public class KeepReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public KeepReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Keep) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistKeep_4002(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistKeep_4002(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Keep getLink() {
		return (Keep) getElementToEdit();
	}
