...
import trnetvisual.diagram.edit.commands.TrnetvisualCreateShortcutDecorationsCommand;
import trnetvisual.diagram.edit.policies.TrNetModelCanonicalEditPolicy;
import trnetvisual.diagram.edit.policies.TrNetModelItemSemanticEditPolicy;
import trnetvisual.diagram.part.TrnetvisualVisualIDRegistry;

/**
 * @generated
 */
public class TrNetModelEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Trnetvisual"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public TrNetModelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TrNetModelItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TrNetModelCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new TrnetvisualCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
