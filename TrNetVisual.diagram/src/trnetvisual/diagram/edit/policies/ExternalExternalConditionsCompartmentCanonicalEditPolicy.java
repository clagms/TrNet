 ...
 * @generated
 */
public class ExternalExternalConditionsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getExternalExternalConditionsCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<TrnetvisualNodeDescriptor> childDescriptors = TrnetvisualDiagramUpdater
				.getExternalExternalConditionsCompartment_7003SemanticChildren((View) getHost()
						.getModel());
