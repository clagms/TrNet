 ...
 * @generated
 */
public class ExternalConditionCallIdEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExternalConditionCallIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrnetvisualParserProvider
					.getParser(
							TrnetvisualElementTypes.ExternalConditionCall_3001,
							getParserElement(),
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.ExternalConditionCallIdEditPart.VISUAL_ID));
		}
		return parser;
	}
