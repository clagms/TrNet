 ...
 * @generated
 */
public class AnyOperandReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AnyOperandReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AnyOperand) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAnyOperand_4005(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TrNetModel container = (TrNetModel) getLink().eContainer();
		return TrnetvisualBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAnyOperand_4005(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AnyOperand getLink() {
		return (AnyOperand) getElementToEdit();
	}
