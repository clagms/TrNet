 ...
 * @generated
 */
public class TrnetvisualViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TrNetModelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TrnetvisualVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = TrnetvisualVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!TrnetvisualElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != TrnetvisualVisualIDRegistry
				...
				if (!TrNetModelEditPart.MODEL_ID
						.equals(TrnetvisualVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ExternalAttributeCalculationCallEditPart.VISUAL_ID == visualID
				|| ExternalCalculationCallEditPart.VISUAL_ID == visualID
				|| CombinatorEditPart.VISUAL_ID == visualID
				|| ExternalEditPart.VISUAL_ID == visualID
				|| PatternEditPart.VISUAL_ID == visualID
				|| ExternalConditionCallEditPart.VISUAL_ID == visualID
				|| ExternalActionCallEditPart.VISUAL_ID == visualID
				|| MandatoryNodeEditPart.VISUAL_ID == visualID
				|| AttributePatternEditPart.VISUAL_ID == visualID
				|| OptionalNodeEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TrnetvisualVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TrnetvisualVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(TrNetModelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = TrnetvisualVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ExternalAttributeCalculationCallEditPart.VISUAL_ID:
			return createExternalAttributeCalculationCall_2001(domainElement,
					containerView, index, persisted, preferencesHint);
		case ExternalCalculationCallEditPart.VISUAL_ID:
			return createExternalCalculationCall_2002(domainElement,
					containerView, index, persisted, preferencesHint);
		case CombinatorEditPart.VISUAL_ID:
			return createCombinator_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ExternalEditPart.VISUAL_ID:
			return createExternal_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case PatternEditPart.VISUAL_ID:
			return createPattern_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case ExternalConditionCallEditPart.VISUAL_ID:
			return createExternalConditionCall_3001(domainElement,
					containerView, index, persisted, preferencesHint);
		case ExternalActionCallEditPart.VISUAL_ID:
			return createExternalActionCall_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case MandatoryNodeEditPart.VISUAL_ID:
			return createMandatoryNode_3003(domainElement, containerView,
					index, persisted, preferencesHint);
		case AttributePatternEditPart.VISUAL_ID:
			return createAttributePattern_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		case OptionalNodeEditPart.VISUAL_ID:
			return createOptionalNode_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TrnetvisualVisualIDRegistry.getVisualID(elementTypeHint)) {
		case SameEditPart.VISUAL_ID:
			return createSame_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case KeepEditPart.VISUAL_ID:
			return createKeep_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case AnyResultEditPart.VISUAL_ID:
			return createAnyResult_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case SomeResultEditPart.VISUAL_ID:
			return createSomeResult_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case AnyOperandEditPart.VISUAL_ID:
			return createAnyOperand_4005(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case SomeOperandEditPart.VISUAL_ID:
			return createSomeOperand_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case AntiOperandEditPart.VISUAL_ID:
			return createAntiOperand_4007(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case OptionalOperandEditPart.VISUAL_ID:
			return createOptionalOperand_4008(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case NextEditPart.VISUAL_ID:
			return createNext_4009(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case EventuallyEditPart.VISUAL_ID:
			return createEventually_4010(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case NextDerivedEditPart.VISUAL_ID:
			return createNextDerived_4011(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ExternalAttributeCalculationCallParameterEditPart.VISUAL_ID:
			return createExternalAttributeCalculationCallParameter_4012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ExternalConditionCallParameterEditPart.VISUAL_ID:
			return createExternalConditionCallParameter_4013(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ExternalActionCallParameterEditPart.VISUAL_ID:
			return createExternalActionCallParameter_4014(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ExternalCalculationCallParameterEditPart.VISUAL_ID:
			return createExternalCalculationCallParameter_4015(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case EdgePatternEditPart.VISUAL_ID:
			return createEdgePattern_4016(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case ExternalAttributeCalculationCallResultEditPart.VISUAL_ID:
			return createExternalAttributeCalculationCallResult_4017(
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createExternalAttributeCalculationCall_2001(
		...
		node.setType(TrnetvisualVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createExternalCalculationCall_2002(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createCombinator_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createExternal_2004(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createPattern_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createExternalConditionCall_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createExternalActionCall_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createMandatoryNode_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Node createAttributePattern_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createOptionalNode_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
	 ...
	 * @generated
	 */
	public Edge createSame_4001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(TrnetvisualVisualIDRegistry
				.getType(SameEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createKeep_4002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TrnetvisualVisualIDRegistry
				.getType(KeepEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createAnyResult_4003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createSomeResult_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAnyOperand_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createSomeOperand_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAntiOperand_4007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createOptionalOperand_4008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createNext_4009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TrnetvisualVisualIDRegistry
				.getType(NextEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createEventually_4010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createNextDerived_4011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createExternalAttributeCalculationCallParameter_4012(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createExternalConditionCallParameter_4013(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createExternalActionCallParameter_4014(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createExternalCalculationCallParameter_4015(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createEdgePattern_4016(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createExternalAttributeCalculationCallResult_4017(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
