 ...
 * @generated
 */
public class TrnetvisualNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TrnetvisualNavigatorItem) {
					selectedElement = ((TrnetvisualNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (TrNetModelEditPart.MODEL_ID
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TrnetvisualDiagramEditor.ID);
