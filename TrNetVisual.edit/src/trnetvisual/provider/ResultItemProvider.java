...
/**
 * This is the item provider adapter for a {@link trnetvisual.Result} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TrnetvisualPackage.Literals.RESULT__PATTERN,
         true,
         false,
         true,
         null,
  ...
  protected void addOperatorPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Result_operator_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Result_operator_feature", "_UI_Result_type"),
         TrnetvisualPackage.Literals.RESULT__OPERATOR,
         true,
         false,
         true,
         null,
