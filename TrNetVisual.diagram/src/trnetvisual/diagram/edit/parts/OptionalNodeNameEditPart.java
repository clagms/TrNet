 ...
 * @generated
 */
public class OptionalNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OptionalNodeNameEditPart(View view) {
		super(view);
	}
			...
			parser = TrnetvisualParserProvider
					.getParser(
							...
							TrnetvisualVisualIDRegistry
									.getType(trnetvisual.diagram.edit.parts.OptionalNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
