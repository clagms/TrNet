 ...
 * @generated
 */
public class TrnetvisualDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TrnetvisualDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof TrnetvisualDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((TrnetvisualDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new TrnetvisualDomainNavigatorItem(
